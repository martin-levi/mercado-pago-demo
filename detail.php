...
<?php 
    ...
    $direccion="https://martin-levi-mp-commerce-nodejs.herokuapp.com/";
    ...
    $item->picture_url = $direccion.$_POST['img']; 
    $item->currency_id ="ARS";  
    $preference->items = array($item);
    $preference->external_reference = "martinl@seincomp.com.ar";
    $preference->notification_url= $direccion."webhook.php";
    $preference->auto_return= "approved";
    $preference->back_urls = array(
        "success" => $direccion."succes.php",
        "pending" => $direccion."pending.php",
        "failure" => $direccion."failure.php"
    );
